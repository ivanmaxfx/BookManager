        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_events_available_seats_range", "available_seats >= 0 AND available_seats <= total_seats");
                    table.CheckConstraint("ck_events_total_seats_positive", "total_seats > 0");
                });
